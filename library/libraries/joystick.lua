...
--- Joystick library.
--- View [source](https://github.com/thegrb93/StarfallEx/blob/master/lua/starfall/libs_cl/joystick.lua#L13).
joystick = {}

--- ![](https://github.com/Periapsises/Starfall-LLS/blob/generator/resources/client.png?raw=true)
--- Gets the axis data value.
--- View [source](https://github.com/thegrb93/StarfallEx/blob/master/lua/starfall/libs_cl/joystick.lua#L24).
...
--- View [source](https://github.com/thegrb93/StarfallEx/blob/master/lua/starfall/libs_cl/joystick.lua#L42).
---@param enum number # Joystick number. Starts at 0
...
--- View [source](https://github.com/thegrb93/StarfallEx/blob/master/lua/starfall/libs_cl/joystick.lua#L51).
---@param enum number # Joystick number. Starts at 0
...
--- View [source](https://github.com/thegrb93/StarfallEx/blob/master/lua/starfall/libs_cl/joystick.lua#L33).
---@param enum number # Joystick number. Starts at 0
...
--- View [source](https://github.com/thegrb93/StarfallEx/blob/master/lua/starfall/libs_cl/joystick.lua#L65).
---@param enum number # Joystick number. Starts at 0
...
--- View [source](https://github.com/thegrb93/StarfallEx/blob/master/lua/starfall/libs_cl/joystick.lua#L73).
---@param enum number # Joystick number. Starts at 0
...
--- View [source](https://github.com/thegrb93/StarfallEx/blob/master/lua/starfall/libs_cl/joystick.lua#L59).
---@return number # Number of joysticks
function joystick.numJoysticks() end

--- ![](https://github.com/Periapsises/Starfall-LLS/blob/generator/resources/client.png?raw=true)
--- Gets the number of detected povs on a joystick.
--- View [source](https://github.com/thegrb93/StarfallEx/blob/master/lua/starfall/libs_cl/joystick.lua#L81).
---@param enum number # Joystick number. Starts at 0
